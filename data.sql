...
-- ============================================================
-- TOURISTS & REVIEWS (Removed as requested)
-- ============================================================

-- ============================================================
-- TOURIST SPOTS (Iligan City)
-- ============================================================
INSERT INTO TouristSpot (DestinationID, Name, Address, City, Description, Experience, ImageURL, EmbedMapURL) VALUES
(
  1,
...
-- ============================================================
-- ACTIVITIES (Varying allocations)
-- ============================================================
